...
htmlhelp_basename = 'omniformsdoc'
...
latex_documents = [
    (master_doc, 'omniforms.tex', u'omniforms Documentation',
     u'Omni Digital', 'manual'),
]
...
man_pages = [
    (master_doc, 'omniforms', u'omniforms Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'omniforms', u'omniforms Documentation',
     author, 'omniforms', 'One line description of project.',
     'Miscellaneous'),
]
