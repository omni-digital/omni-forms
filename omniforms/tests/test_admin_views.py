...
from omniforms.tests.factories import OmniCharFieldFactory
...
class OmniModelFormCreateFieldViewTestCase(OmniModelFormAdminTestCaseStub):
    ...
    def test_renders(self):
        ...
        """
        response = self.client.get(self.url)
        self.assertTemplateUsed(response, 'admin/omniforms/omnimodelform/field_form.html')
...
class OmniFormCreateFieldViewTestCase(OmniBasicFormAdminTestCaseStub):
    ...
    def test_renders(self):
        ...
        """
        response = self.client.get(self.url)
        self.assertTemplateUsed(response, 'admin/omniforms/omniform/field_form.html')
